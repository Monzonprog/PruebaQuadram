...
import com.example.jorge.pruebaquadram.Class.Feed;
...
public class TopFreeFragment extends Fragment implements IDataApp {
    ...
    public void conexionCorrecta(AppObject listApp) {
        ...
        recycler = (RecyclerView)getActivity().findViewById(R.id.recyclerFragmentFree);
